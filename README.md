...
- **`microsandbox_service`** - light HTTP wrapper for microsandbox.  
  See [`microsandbox_service/README.md`](microsandbox_service/README.md).

Each package is self-contained; head into the one and follow its README to install and run it.
